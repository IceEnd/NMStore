...
function getCarsByUserId(user_id) {
    ...
    pool.getConnection(function (err, connection) {
        connection.query('select a.*,b.*,c.src from cars as a left join  goods as b on (a.goods_id = b.goods_id) left join goods_images as c on (a.goods_id = c.goods_id) where b.goods_state = 0 AND a.user_id = ' + 
